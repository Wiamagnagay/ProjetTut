...
function onNext() {
  ...
  if (expeSelectionnee) {
    if (expeSelectionnee.necessitePro === true && !formStore.idProLie) {
      erreurSelection.value =
        "Cette expérimentation nécessite l'accompagnement d'un professionnel de santé. Veuillez en parler à votre médecin pour qu'il procède à votre inscription.";
      return;
    }
